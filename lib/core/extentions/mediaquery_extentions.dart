...
extension MediaQueryDtx on BuildContext {
  ...
  @Deprecated('Use textScaleFactor instead.')
  ...
  @Deprecated('Use isPhoneScreen instead.')
  bool get isMediumPhoneScreen => shortestScreenSide >= 360 && shortestScreenSide < 400;

  @Deprecated('Use isPhoneScreen instead.')
  bool get isLargePhoneScreen => shortestScreenSide >= 400 && shortestScreenSide < 600;

  @Deprecated('Use isTabletScreen instead.')
  bool get isSmallTabletScreen => shortestScreenSide >= 600 && shortestScreenSide < 720;

  @Deprecated('Use isTabletScreen instead.')
  bool get isLargeTabletScreen => shortestScreenSide >= 720 && shortestScreenSide < 960;
